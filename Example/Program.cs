...
namespace Example
{
    public class Program
    {
        ...
        {
            Console.WriteLine(GetDirectoryTree("D:\\Riot Games"));
            Console.ReadLine();
        }

        #region Phần 7 - Stream và File

        private static void GetDirectoryAndFile()
        {
            var path = $"C:\\";
        ...
        private static string _directoryTree = string.Empty;

        private static string GetDirectoryTree(string path)
        {
        ...
        private static void DirectoryTreeRecursion(DirectoryInfo dir, int level)
        {
            var directories = dir.GetDirectories();
            int tab = level;
